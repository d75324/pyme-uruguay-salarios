import csv
import os
from ingresar_datos_empleados_f import ingresar_datos_empleados
...
tabla_de_empleados = [['Nombre', 'Apellido', 'Salario Base', 'AFP a la que pertenece', 'Ingreso', 'Cantidad Hijos a Cargo', 'Bonificacion', 'Asignacion', 'Pagar a FONASA', 'Pagar a AFP'],]
...
print(tabla_de_empleados[1][4])
print(type(tabla_de_empleados[1][4]))